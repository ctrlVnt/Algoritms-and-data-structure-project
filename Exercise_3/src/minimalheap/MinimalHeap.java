...
public class MinimalHeap<G>{
  ...
  */
  ...
  public void insert(G x) throws MinimalHeapException{
    if(this.map.get(x) == null){
      ...
      throw new MinimalHeapException("This element already exists inside the Min heap");
    }
  }
 ...
 /**
  ...
  /**
   * return the index of the smallest element between head, left and right element
  ...
  public void decreaseValue(G oldEl, G newEl)throws MinimalHeapException{
    ...
    if(this.map.get(newEl) != null){
      throw new MinimalHeapException("the new value already exists");
    }
